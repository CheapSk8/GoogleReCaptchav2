...
namespace GoogleReCaptcha
{
    ...
    public class GoogleReCaptcha : WebControl
    {
        ...
        protected override void RenderContents(HtmlTextWriter output)
        {
            ...
            {
                string reCaptchaHTML = $"<div class='g-recaptcha' data-sitekey='{PublicKey}'></div>";
        ...
        public bool Validate()
        {
            ...
            if (string.IsNullOrEmpty(EncodedResponse) || string.IsNullOrEmpty(PrivateKey)) { return false; }
